...
headers = {
	"X-RapidAPI-Key": "5bc173e353msh18b357bc0c3b2cap1abd3fjsnd1d5a7a70751",
...
footer = '''
    ...
    <div class="footer">
        <p>This version of the app code copied from <a href="https://dev.to/dotaadarsh/lets-create-a-simple-weather-app-part-1-5147" target="_blank">Aadarsh Kannan</a></p>
    </div>
    '''
